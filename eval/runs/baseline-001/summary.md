# Run baseline-001 (baseline)

suite `8c261a1d0b4e` (56 records, 56 in this run) - corpus `live` - R=5 - template T pinned in manifest
...
axes: accuracy control: 5/6 / near-miss: 7/8 / positive: 39/42; prompt 227910 tok; completion 3610 tok (reasoning 0); material 206350 tok (mean 737 per call)
